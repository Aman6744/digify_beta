...
class Binarization {
    public:
        Binarization();
        void binarize(Mat image, Mat &output, Mat &_output, bool light, int option);
    ...
    private:
        ...
        void thresholdImg(Mat im, Mat &output, Mat &smoothedImg, int option, int winx, int winy, double k, double dR);
